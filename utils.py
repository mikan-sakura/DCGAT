...
class Params:
    ...
    def __init__(self, ex_index=3, corpus_type='CMeIE-V2'):
        ...
        self.bert_model_dir = '/CSTemp/wyq/py_project/PRGC/pretrain_models/chinese-roberta-wwm-ext'
        #self.bert_model_dir = '/CSTemp/wyq/py_project/PRGC/pretrain_models/ERNIE'
        #self.bert_model_dir = '/CSTemp/wyq/py_project/PRGC/pretrain_models/chinese-bert-wwm'
        ...
        # 新增参数配置（假设已在utils.Params中定义）
        self.pos_vocab_size = 512  # POS标签数量
        self.token_vocab_size = 512  # Token类型数量（如实体类型等）
        self.pos_emb_dim = 100
        self.token_emb_dim = 150

         # 添加消融实验参数
        self.use_pos = True  # 是否使用位置编码
        self.use_token = True  # 是否使用token类型编码
        self.use_gat = True  # 是否使用GAT层
        self.use_dgcnn = True  # 是否使用DGCNN融合
        self.use_gate = True  # 是否使用门控融合
        self.ensure_corres = True  # 是否使用对应关系模块
        self.ensure_rel = True  # 是否使用关系判断模块
